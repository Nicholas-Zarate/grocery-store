...
//---Handle Submitting of Update Request---
  ...
  const handleSubmit = () => {
    ...
    let dataSend = {};
    if(nameEdit!=''){dataSend.name = nameEdit};
    if(sectionEdit!=''){dataSend.section = sectionEdit};
    if(priceEdit!=''){dataSend.price = priceEdit};
    if(quantityEdit!=''){dataSend.quantity = quantityEdit};
    ...
    <div className="edit-container">
      <div className="edit-header">
        ...
        <div id="col2">
          ...
          <div id='display-quantity'>Quantity: n={props.selection.quantity}</div>
        </div>
      </div>
      ...
      <div className="edit-buttons">
        <Button color="primary" variant="contained" id='edit-submit' onClick={()=>handleSubmit()}>Submit</Button>
        <Button color="error" startIcon={<CancelIcon/>} onClick={()=>{handleClose()}}></Button>
      </div>
    </div>
    )
}
